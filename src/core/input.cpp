...
Vector2f Input::mouse_position; //last mouse position
Vector2f Input::mouse_delta; //mouse movement in the last frame
...
void Input::centerMouse()
{
	...
	//put the mouse back in the middle of the screen
	int center_x = (int)floor(size.x*0.5f);
	int center_y = (int)floor(size.y*0.5f);
	CORE::setCursorPosition(center_x, center_y);
